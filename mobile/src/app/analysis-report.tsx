...
const styles = StyleSheet.create({
  ...
  loadingText: { marginTop: 16, color: '#57534e', fontSize: 16, fontFamily: 'Geist_500Medium', fontWeight: '500' },
  content: { padding: 24, paddingBottom: 40 },
  header: { marginBottom: 24 },
  headerLabel: { color: '#c2410c', fontSize: 12, fontFamily: 'Geist_700Bold', fontWeight: '700', letterSpacing: 1, marginBottom: 8 },
  headerTitle: { fontSize: 32, fontFamily: 'Geist_900Black', fontWeight: '900', color: '#000', marginBottom: 12 },
  headerTitleLight: { fontWeight: '300', color: '#78716c' },
  atsBadge: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fafafa', alignSelf: 'flex-start', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20, borderWidth: 1, borderColor: '#e4e4e7' },
  atsBadgeText: { marginLeft: 8, color: '#166534', fontWeight: 'bold' },
  card: { backgroundColor: '#ffffff', padding: 24, borderRadius: 24, borderWidth: 1, borderColor: '#e4e4e7', marginBottom: 24 },
  cardTitle: { fontSize: 18, fontFamily: 'Geist_700Bold', fontWeight: '700', color: '#000', marginBottom: 12 },
  cardText: { fontSize: 16, color: '#44403c', lineHeight: 24 },
  section: { marginBottom: 24 },
  sectionLabel: { fontSize: 12, fontFamily: 'Geist_700Bold', fontWeight: '700', color: '#78716c', letterSpacing: 1, marginBottom: 16 },
  chipsContainer: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  chip: { backgroundColor: '#ffffff', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 12, borderWidth: 1, borderColor: '#e4e4e7' },
  chipText: { fontSize: 14, fontFamily: 'Geist_600SemiBold', fontWeight: '600', color: '#292524' },
  cardHeaderRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 24 },
  iconBoxGreen: { width: 48, height: 48, borderRadius: 16, backgroundColor: '#fafafa', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#e4e4e7', marginRight: 16 },
  iconBoxOrange: { width: 48, height: 48, borderRadius: 16, backgroundColor: '#fafafa', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#e4e4e7', marginRight: 16 },
  cardTitleLarge: { fontSize: 24, fontFamily: 'Geist_700Bold', fontWeight: '700', color: '#000' },
  listItem: { flexDirection: 'row', marginBottom: 20 },
  listIcon: { marginRight: 16, marginTop: 2 },
  dotIconBox: { width: 24, height: 24, borderRadius: 12, backgroundColor: '#fafafa', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#e4e4e7', marginRight: 16, marginTop: 2 },
  dot: { width: 8, height: 8, borderRadius: 4, backgroundColor: '#ea580c' },
  listContent: { flex: 1 },
  listTitle: { fontSize: 16, fontFamily: 'Geist_700Bold', fontWeight: '700', color: '#000', marginBottom: 4 },
  listText: { fontSize: 15, color: '#57534e', lineHeight: 22 },
  emptyText: { color: '#78716c', fontSize: 15 },
  feedbackBox: { marginTop: 16, padding: 16, backgroundColor: '#fafafa', borderRadius: 16, borderWidth: 1, borderColor: '#e4e4e7' },
  feedbackLabel: { fontSize: 10, fontFamily: 'Geist_700Bold', fontWeight: '700', color: '#78716c', letterSpacing: 1, marginBottom: 4 },
  feedbackText: { fontSize: 14, color: '#44403c' },
  subtitleText: { color: '#57534e', marginBottom: 24 },
  jobCard: { backgroundColor: '#ffffff', padding: 24, borderRadius: 24, borderWidth: 1, borderColor: '#e4e4e7', marginBottom: 16 },
  jobIconBox: { width: 48, height: 48, borderRadius: 12, backgroundColor: '#fafafa', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#e4e4e7', marginBottom: 16 },
  jobTitle: { fontSize: 18, fontFamily: 'Geist_700Bold', fontWeight: '700', color: '#000', marginBottom: 4 },
  jobEmployer: { fontSize: 16, fontFamily: 'Geist_500Medium', fontWeight: '500', color: '#44403c' },
  ...
  applyBtnText: { color: '#fff', fontFamily: 'Geist_700Bold', fontWeight: '700', fontSize: 14 },
  emptyJobCard: { padding: 40, backgroundColor: '#ffffff', borderRadius: 24, borderWidth: 1, borderColor: '#e4e4e7', borderStyle: 'dashed', alignItems: 'center' },
  emptyJobTitle: { fontSize: 18, fontFamily: 'Geist_700Bold', fontWeight: '700', color: '#000', marginTop: 16 },
});
