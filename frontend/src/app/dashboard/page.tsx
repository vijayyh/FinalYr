    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground transition-colors duration-300 relative overflow-x-hidden pt-12">
      ...
      <main className="max-w-[1200px] w-full mx-auto px-8 relative z-10 pb-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Link href="/tools/skill-tracker" className="group">
            <div className="glass h-full p-6 rounded-3xl border border-white/20 dark:border-white/10 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 hover:border-indigo-500/50">
              <div className="w-10 h-10 rounded-xl bg-indigo-500/10 flex items-center justify-center mb-4 group-hover:bg-indigo-500 transition-colors">
                <BookmarkCheck className="w-5 h-5 text-indigo-600 dark:text-indigo-400 group-hover:text-white transition-colors" />
              </div>
              <h3 className="font-bold mb-2">Skill Tracker</h3>
              <p className="text-sm text-muted-foreground">Track missing competencies and monitor removal timestamps.</p>
            </div>
          </Link>
